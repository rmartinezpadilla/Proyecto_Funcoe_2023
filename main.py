...
from routers import adviser_router, concept_router, day_router, enroll_router, module_router, payments_router, pensum_router, program_router, semester_router, student_router, teacher_router, user_router
